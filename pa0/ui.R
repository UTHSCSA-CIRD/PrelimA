...
shinyUI(pageWithSidebar(
          ...
          sidebarPanel(
            ...
            htmlOutput("mgvar"), htmlOutput("mxvars"),
            htmlOutput("mtvar"),
            htmlOutput("mcmeth"),
            htmlOutput("msvars"),
            htmlOutput("mrvars"),
            ...
            tabsetPanel(
              ...
              tabPanel("Model",
                       ...
                       conditionalPanel('$("#zphspan").text()===""',
                                        plotOutput("resplot"),
                                        conditionalPanel("$('#resplot img').attr('src')!=='null'",
                                                         selectInput("mtrend",
                                        ...
                                        conditionalPanel("$('#resplotabs img').attr('src')!=='null'",
                                                         selectInput("mabstrend",
                                                                     "Please choose the best description for the gray points:",
                                                                     c(' ','Upward Trend','Highest in the Middle (Peak)','Lowest in the Middle (Valley)',
                                                                       'Downward Trend','Approximately Flat','Other')),
                                                         selectInput("mabsnonlin",
                                                                     "Is the fit of the dotted blue line to the gray points noticeably better than the fit of the solid red line to the gray points?",
                                                                     c(' ','Yes','No'))),
                                        plotOutput("resplotqq"),
                                        conditionalPanel("$('#resplotqq img').attr('src')!=='null'",
                                                         selectInput("mqqldir","If the LEFT tail of this plot above or below the red line?",c(' ','Above','Below')),
                                                         selectInput("mqqrdir","If the RIGHT tail of this plot above or below the red line?",c(' ','Above','Below')),
                                                         sliderInput("sqqrange",
